...
if __name__ == "__main__":
    ...
    data = all_data
    # all_data = pd.concat([data, val_data])
    ...
    for feat in sparse_features:
        ...
        # val_data[feat] = lbe.fit_transform(val_data[feat])  #TODO ***** this line is wrong try to use fit and transform and correct all the codes
    ...
    history = model.fit(model_input, data[target].values, batch_size=256, epochs=1000, verbose=2, validation_split=0.2)
